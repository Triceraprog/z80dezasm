...
def load_rom_with_comments(rom_filename, comments_filename):
    ...
    data_skip_regions = get_data_skip_regions(comments.all_directives())
    starting_addresses = get_starting_addresses(comments.all_directives(), data_skip_regions)
...
def get_starting_addresses(directives, data_skip_regions=None):
...
def get_data_skip_regions(directives):
